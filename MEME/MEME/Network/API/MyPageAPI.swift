...
//  MEME
//
//  Created by 임아영 on 2/9/24. f5651521fbf96e6d32f9554aa5455f516ee9d07b
//
...
extension MyPageAPI: MemeAPI {
    ...
    var headerType: HTTPHeaderFields {
        switch self {
        case .getMyPageProfile, .getMyPage, .patchProfile, .getFavoriteArtist, .getFavoritePortfolio, .postFavoriteArtist, .postFavoritePortfolio, .deleteFavoriteArtist, .deleteFavoritePortfolio:
    ...
    var method: Moya.Method {
        ...
        case .patchProfile:
            return .patch
        case .getMyPageProfile, .getMyPage, .getFavoriteArtist, .getFavoritePortfolio:
            return .get
